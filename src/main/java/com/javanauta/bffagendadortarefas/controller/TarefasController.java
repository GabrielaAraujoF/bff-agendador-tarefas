...
@Tag(name = "Tarefas", description = "Cadastra tarefas dos usuários")
...
public class TarefasController {
    ...
    @ApiResponse(responseCode = "200", description = "Tarefas encontradas")
    @ApiResponse(responseCode = "500", description = "Erro de servidor")
    public ResponseEntity<List<TarefasDTOResponse>> buscarTarefasPorEmail(@RequestHeader (name = "Authorization",
